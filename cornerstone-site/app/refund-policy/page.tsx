  ...
  return (
    <main className="min-h-screen bg-background text-foreground">
      <div className="max-w-3xl mx-auto px-6 py-24 md:py-32">
        ...
        <h1 className="text-4xl md:text-5xl font-bold tracking-tighter mb-4">Refund &amp; Cancellation Policy</h1>
        <p className="text-muted mb-12">Effective date: 9 April 2026</p>
        ...
        <div className="prose-custom space-y-10 text-muted text-base leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-bold text-foreground mb-3">2. Discovery Sprint</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-foreground mb-3">3. Build Phase (OS Development)</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-foreground mb-3">4. Retainer &amp; Hourly Engagements</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-foreground mb-3">5. Scope Changes</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-foreground mb-3">6. Ownership of Deliverables</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-foreground mb-3">7. How to Request a Refund or Cancel</h2>
            <p>
